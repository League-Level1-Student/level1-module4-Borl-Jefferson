...
JOptionPane.showMessageDialog(null, "Press the matching hey when 'Simon says' otherwise press a different key or bad");
...
frame.setName("Just Pretend the Entire Bee Movie Script is Here");
		// 9. Pack the frame
frame.pack();

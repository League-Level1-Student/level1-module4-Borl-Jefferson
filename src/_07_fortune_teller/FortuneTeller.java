...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
    ...
    FortuneTeller() throws Exception {
   	 ...
   	 fortuneTellerImage = ImageIO.read(getClass().getResource("were is teh waldo.png"));
...
System.out.println(mouseX + "(X)," + mouseY + "(Y)");
   	 ...
   	 if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
   	 	...
   	 	void eightball () {
   	   	...
   	   	if (a == 3) {
   	   		JOptionPane.showMessageDialog(null, "I don'tn't posess the knoledge to present the information for you to intake to let you know that I cant'ntn't tell you if the answer you are looking for is yesn't or not a no.");
   	   	}
